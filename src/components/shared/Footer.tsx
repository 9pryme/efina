      ...
      <div className="relative">
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-display text-[56px] leading-[64px] mb-4">
              Stay informed by subscribing<br />to our newsletter.
            </h2>
            <p className="text-lg text-gray-300 mb-8">
              Join our community to receive a wealth of <br /> information, stories, and highlights about our 
              work and impact.
            </p>
            <form onSubmit={handleSubmit} className="flex gap-4 max-w-2xl mx-auto">
              ...
              <Button 
                type="submit"
                variant="primary"
                className="bg-[#008F60] hover:bg-[#006B48]"
              >
                Subscribe now
              </Button>
            </form>
